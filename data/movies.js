...
const vodCategories = [
  ...
  { category_id: "14", category_name: "Multi-Audio & Subtitle Test Clips", parent_id: 0 },
...
const vodStreams = [
  ...
  { num: 23, name: "Broadcast Relic 4:3", stream_id: 222, category_id: "16", container_extension: "m3u8", source: SRC.bipbop4x3, stream_icon: poster("broadcast-relic-4x3"), plot: "Recovered from a station's tape vault before the transition to widescreen.", cast: "Archival material - no credited cast", director: "Unknown", studio: "Graymantle Archive Division", rating: "n/a", releasedate: "1994-11-02" },
  ...
  { num: 25, name: "Concrete & Motion", stream_id: 227, category_id: "17", container_extension: "m3u8", source: SRC.skate4k, stream_icon: poster("concrete-and-motion"), plot: "A high-frame-rate documentary short following skaters through an abandoned industrial district, shot on phantom flex cameras for ultra-slow-motion sequences.", cast: "Featuring: Callum Beaumont, Kaia Munro", director: "Dario Castellano", studio: STUDIOS[5], rating: "7.7", releasedate: "2023-11-20" },

  // --- Multi-Audio & Subtitle Test Clips (genuinely verified multi-track sources) ---
