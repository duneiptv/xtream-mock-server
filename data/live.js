...
const liveCategories = [
  ...
  { category_id: "2", category_name: "Kids and Animation", parent_id: 0 },
  { category_id: "3", category_name: "Sci-Fi and Fantasy", parent_id: 0 },
  { category_id: "4", category_name: "Arts and Culture", parent_id: 0 },
  { category_id: "5", category_name: "Retro and Classic TV", parent_id: 0 },
  { category_id: "6", category_name: "Test Pattern Network", parent_id: 0 },
  { category_id: "7", category_name: "Documentary and Nature", parent_id: 0 },
  { category_id: "8", category_name: "Music and Nightlife", parent_id: 0 },
  { category_id: "9", category_name: "Sports and Action", parent_id: 0 },
];
...
const liveStreams = [
  ...
  // --- Kids and Animation (Big Buck Bunny footage) ---
  ...
  // --- Sci-Fi and Fantasy (Tears of Steel / Sintel footage) ---
  ...
  { num: 13, name: "Ember and Ash Network", stream_id: 114, category_id: "3", source: SRC.sintel, stream_icon: logo("EA", "14532d", "fde047"), epg_channel_id: "emberash.fantasy" },

  // --- Arts and Culture (Elephants Dream footage) ---
  ...
  // --- Retro and Classic TV (BipBop test-pattern footage, styled as retro) ---
  ...
  // --- Sports and Action (new skate 4K source) ---
